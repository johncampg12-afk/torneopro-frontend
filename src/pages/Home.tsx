        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex gap-3">
              {user ? (
                <Link to="/tournaments/create" className="btn-primary text-lg px-8 py-4">
                ...
                <>
                  ...
                  <Link to="/login" className="btn-secondary text-lg px-6 py-4">
                    Iniciar sesión
                  </Link>
                </>
              )}
      ...
      {loading ? (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {publicTournaments.map(t => (
            <Link key={t.id} to={`/t/${t.shareCode}`} className="glass p-6 hover-lift group block">
              <div className="flex items-start justify-between mb-4">
                ...
                <span className={`px-3 py-1 rounded-full text-xs font-bold ${t.status === 'active' ? 'bg-accent-500/20 text-accent-400' : 'bg-slate-700 text-slate-400'}`}>
